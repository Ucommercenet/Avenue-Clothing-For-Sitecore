...
(function (l, m) { "object" === typeof module && module.exports ? module.exports = m() : "function" === typeof define && define.amd ? define(m) : l.IPv6 = m(l) })(this, function (l) {
    var m = l && l.IPv6; return {
        best: function (g) {
            g = g.toLowerCase().split(":"); var f = g.length, d = 8; "" === g[0] && "" === g[1] && "" === g[2] ? (g.shift(), g.shift()) : "" === g[0] && "" === g[1] ? g.shift() : "" === g[f - 1] && "" === g[f - 2] && g.pop(); f = g.length; -1 !== g[f - 1].indexOf(".") && (d = 7); var h; for (h = 0; h < f && "" !== g[h]; h++); if (h < d) for (g.splice(h, 1, "0000") ; g.length < d;) g.splice(h, 0, "0000");
            for (h = 0; h < d; h++) { for (var f = g[h].split(""), l = 0; 3 > l; l++) if ("0" === f[0] && 1 < f.length) f.splice(0, 1); else break; g[h] = f.join("") } var f = -1, p = l = 0, m = -1, u = !1; for (h = 0; h < d; h++) u ? "0" === g[h] ? p += 1 : (u = !1, p > l && (f = m, l = p)) : "0" === g[h] && (u = !0, m = h, p = 1); p > l && (f = m, l = p); 1 < l && g.splice(f, l, ""); f = g.length; d = ""; "" === g[0] && (d = ":"); for (h = 0; h < f; h++) { d += g[h]; if (h === f - 1) break; d += ":" } "" === g[f - 1] && (d += ":"); return d
        }, noConflict: function () { l.IPv6 === this && (l.IPv6 = m); return this }
    }
});
(function (l) {
    function m(d) { throw new RangeError(e[d]); } function g(d, e) { for (var f = d.length, h = []; f--;) h[f] = e(d[f]); return h } function f(d, e) { var f = d.split("@"), h = ""; 1 < f.length && (h = f[0] + "@", d = f[1]); d = d.replace(H, "."); f = d.split("."); f = g(f, e).join("."); return h + f } function d(d) { for (var e = [], f = 0, h = d.length, g, a; f < h;) g = d.charCodeAt(f++), 55296 <= g && 56319 >= g && f < h ? (a = d.charCodeAt(f++), 56320 == (a & 64512) ? e.push(((g & 1023) << 10) + (a & 1023) + 65536) : (e.push(g), f--)) : e.push(g); return e } function h(d) {
        ...
        var e = [], f = d.length, g, l = 0, a = 128, b = 72, c, k, n, q, y; c = d.lastIndexOf("-"); 0 > c && (c = 0); for (k = 0; k < c; ++k) 128 <= d.charCodeAt(k) && m("not-basic"), e.push(d.charCodeAt(k)); for (c = 0 < c ? c + 1 : 0; c < f;) {
            k = l; g = 1; for (n = 36; ; n += 36) {
                c >= f && m("invalid-input"); q = d.charCodeAt(c++);
                q = 10 > q - 48 ? q - 22 : 26 > q - 65 ? q - 65 : 26 > q - 97 ? q - 97 : 36; (36 <= q || q > r((2147483647 - l) / g)) && m("overflow"); l += q * g; y = n <= b ? 1 : n >= b + 26 ? 26 : n - b; if (q < y) break; q = 36 - y; g > r(2147483647 / q) && m("overflow"); g *= q
            } g = e.length + 1; b = p(l - k, g, 0 == k); r(l / g) > 2147483647 - a && m("overflow"); a += r(l / g); l %= g; e.splice(l++, 0, a)
        } return h(e)
    } function u(e) {
        var f, g, h, l, a, b, c, k, n, q = [], y, E, I; e = d(e); y = e.length; f = 128; g = 0; a = 72; for (b = 0; b < y; ++b) n = e[b], 128 > n && q.push(t(n)); for ((h = l = q.length) && q.push("-") ; h < y;) {
            c = 2147483647; for (b = 0; b < y; ++b) n = e[b], n >= f && n < c && (c = n);
            E = h + 1; c - f > r((2147483647 - g) / E) && m("overflow"); g += (c - f) * E; f = c; for (b = 0; b < y; ++b) if (n = e[b], n < f && 2147483647 < ++g && m("overflow"), n == f) { k = g; for (c = 36; ; c += 36) { n = c <= a ? 1 : c >= a + 26 ? 26 : c - a; if (k < n) break; I = k - n; k = 36 - n; q.push(t(w(n + I % k, 0))); k = r(I / k) } q.push(t(w(k, 0))); a = p(g, E, h == l); g = 0; ++h } ++g; ++f
        } return q.join("")
    } var B = "object" == typeof exports && exports && !exports.nodeType && exports, C = "object" == typeof module && module && !module.nodeType && module, z = "object" == typeof global && global; if (z.global === z || z.window === z || z.self === z) l =
    z; var v, A = /^xn--/, F = /[^\x20-\x7E]/, H = /[\x2E\u3002\uFF0E\uFF61]/g, e = { overflow: "Overflow: input needs wider integers to process", "not-basic": "Illegal input >= 0x80 (not a basic code point)", "invalid-input": "Invalid input" }, r = Math.floor, t = String.fromCharCode, x; v = { version: "1.3.2", ucs2: { decode: d, encode: h }, decode: D, encode: u, toASCII: function (d) { return f(d, function (d) { return F.test(d) ? "xn--" + u(d) : d }) }, toUnicode: function (d) { return f(d, function (d) { return A.test(d) ? D(d.slice(4).toLowerCase()) : d }) } }; if ("function" ==
    typeof define && "object" == typeof define.amd && define.amd) define("punycode", function () { return v }); else if (B && C) if (module.exports == B) C.exports = v; else for (x in v) v.hasOwnProperty(x) && (B[x] = v[x]); else l.punycode = v
})(this);
(function (l, m) { "object" === typeof module && module.exports ? module.exports = m() : "function" === typeof define && define.amd ? define(m) : l.SecondLevelDomains = m(l) })(this, function (l) {
    var m = l && l.SecondLevelDomains, g = {
        list: {
            ...
            var h = f.lastIndexOf(".", d - 1); if (0 >= h || h >= d - 1) return !1; var l = g.list[f.slice(d + 1)]; return l ? 0 <= l.indexOf(" " + f.slice(h + 1, d) + " ") : !1
            ...
            var d = f.lastIndexOf("."); if (0 >= d || d >= f.length - 1) return null; var h = f.lastIndexOf(".", d - 1); if (0 >= h || h >= d - 1) return null; var l = g.list[f.slice(d + 1)]; return !l || 0 > l.indexOf(" " + f.slice(h +
            1, d) + " ") ? null : f.slice(h + 1)
        }, noConflict: function () { l.SecondLevelDomains === this && (l.SecondLevelDomains = m); return this }
    }; return g
});
(function (l, m) { "object" === typeof module && module.exports ? module.exports = m(require("./punycode"), require("./IPv6"), require("./SecondLevelDomains")) : "function" === typeof define && define.amd ? define(["./punycode", "./IPv6", "./SecondLevelDomains"], m) : l.URI = m(l.punycode, l.IPv6, l.SecondLevelDomains, l) })(this, function (l, m, g, f) {
    function d(a, b) {
        var c = 1 <= arguments.length, k = 2 <= arguments.length; if (!(this instanceof d)) return c ? k ? new d(a, b) : new d(a) : new d; if (void 0 === a) {
        ...
        var c = {}, d, n; if ("RegExp" === w(b)) c = null; else if (p(b)) for (d = 0, n = b.length; d < n; d++) c[b[d]] = !0; else c[b] = !0; d = 0; for (n = a.length; d < n; d++) if (c && void 0 !== c[a[d]] || !c && b.test(a[d])) a.splice(d,
        1), n--, d--; return a
    ...
    d.decodeUrnPath = t(":", "decodeUrnPathSegment"); d.recodePath = t("/", "encodePathSegment", "decode"); d.recodeUrnPath = t(":", "encodeUrnPathSegment", "decode"); d.encodeReserved = G("reserved", "encode"); d.parse = function (a, b) {
        ...
        a = a.replace(/\\/g, "/"); var c = a.indexOf("/"), d; -1 === c && (c = a.length); if ("[" === a.charAt(0)) d = a.indexOf("]"), b.hostname = a.substring(1, d) || null, b.port = a.substring(d + 2, c) || null, "/" === b.port && (b.port = null); else {
            var n = a.indexOf(":"); d = a.indexOf("/"); n = a.indexOf(":", n + 1); -1 !== n &&
            (-1 === d || n < d) ? (b.hostname = a.substring(0, c) || null, b.port = null) : (d = a.substring(0, c).split(":"), b.hostname = d[0] || null, b.port = d[1] || null)
        ...
        var c = a.indexOf("/"), k = a.lastIndexOf("@", -1 < c ? c : a.length - 1); -1 < k && (-1 === c || k < c) ? (c = a.substring(0, k).split(":"), b.username = c[0] ? d.decode(c[0]) : null, c.shift(), b.password = c[0] ?
        d.decode(c.join(":")) : null, a = a.substring(k + 1)) : (b.username = null, b.password = null); return a
    }; d.parseQuery = function (a, b) { if (!a) return {}; a = a.replace(/&+/g, "&").replace(/^\?*&*|&+$/g, ""); if (!a) return {}; for (var c = {}, k = a.split("&"), n = k.length, e, f, g = 0; g < n; g++) if (e = k[g].split("="), f = d.decodeQuery(e.shift(), b), e = e.length ? d.decodeQuery(e.join("="), b) : null, r.call(c, f)) { if ("string" === typeof c[f] || null === c[f]) c[f] = [c[f]]; c[f].push(e) } else c[f] = e; return c }; d.build = function (a) {
        ...
        d.buildHost(a)
    }; d.buildUserinfo = function (a) { var b = ""; a.username && (b += d.encode(a.username)); a.password && (b += ":" + d.encode(a.password)); b && (b += "@"); return b }; d.buildQuery = function (a, b, c) { var k = "", n, e, f, g; for (e in a) if (r.call(a, e) && e) if (p(a[e])) for (n = {}, f = 0, g = a[e].length; f < g; f++) void 0 !== a[e][f] && void 0 === n[a[e][f] + ""] && (k += "&" + d.buildQueryParameter(e, a[e][f], c), !0 !== b && (n[a[e][f] + ""] = !0)); else void 0 !== a[e] && (k += "&" + d.buildQueryParameter(e, a[e], c)); return k.substring(1) }; d.buildQueryParameter = function (a,
    b, c) { return d.encodeQuery(a, c) + (null !== b ? "=" + d.encodeQuery(b, c) : "") }; d.addQuery = function (a, b, c) { if ("object" === typeof b) for (var k in b) r.call(b, k) && d.addQuery(a, k, b[k]); else if ("string" === typeof b) void 0 === a[b] ? a[b] = c : ("string" === typeof a[b] && (a[b] = [a[b]]), p(c) || (c = [c]), a[b] = (a[b] || []).concat(c)); else throw new TypeError("URI.addQuery() accepts an object, string as the name parameter"); }; d.removeQuery = function (a, b, c) {
        var k; if (p(b)) for (c = 0, k = b.length; c < k; c++) a[b[c]] = void 0; else if ("RegExp" === w(b)) for (k in a) b.test(k) &&
        ...
        switch (w(b)) {
            case "String": break; case "RegExp": for (var e in a) if (r.call(a, e) && b.test(e) &&
            (void 0 === c || d.hasQuery(a, e, c))) return !0; return !1; case "Object": for (var f in b) if (r.call(b, f) && !d.hasQuery(a, f, b[f])) return !1; return !0; default: throw new TypeError("URI.hasQuery() accepts a string, regular expression or object as the name parameter");
        } switch (w(c)) {
            case "Undefined": return b in a; case "Boolean": return a = !(p(a[b]) ? !a[b].length : !a[b]), c === a; case "Function": return !!c(a[b], b, a); case "Array": return p(a[b]) ? (k ? u : B)(a[b], c) : !1; case "RegExp": return p(a[b]) ? k ? u(a[b], c) : !1 : !(!a[b] || !a[b].match(c));
            case "Number": c = String(c); case "String": return p(a[b]) ? k ? u(a[b], c) : !1 : a[b] === c; default: throw new TypeError("URI.hasQuery() accepts undefined, boolean, string, number, RegExp, Function as the value parameter");
        }
    }; d.joinPaths = function () {
        for (var a = [], b = [], c = 0, k = 0; k < arguments.length; k++) { var e = new d(arguments[k]); a.push(e); for (var e = e.segment(), f = 0; f < e.length; f++) "string" === typeof e[f] && b.push(e[f]), e[f] && c++ } if (!b.length || !c) return new d(""); b = (new d("")).segment(b); "" !== a[0].path() && "/" !== a[0].path().slice(0,
        ...
        c || (c = {}); var k = c.start || d.findUri.start, e = c.end || d.findUri.end, f = c.trim || d.findUri.trim, g = /[a-z0-9-]=["']?$/i; for (k.lastIndex = 0; ;) {
            var h =
            k.exec(a); if (!h) break; h = h.index; if (c.ignoreHtml) { var l = a.slice(Math.max(h - 3, 0), h); if (l && g.test(l)) continue } var l = h + a.slice(h).search(e), m = a.slice(h, l).replace(f, ""); c.ignore && c.ignore.test(m) || (l = h + m.length, m = b(m, h, l, a), void 0 === m ? k.lastIndex = l : (m = String(m), a = a.slice(0, h) + m + a.slice(l), k.lastIndex = h + m.length))
        } k.lastIndex = 0; return a
    }; d.ensureValidHostname = function (a) {
        if (a.match(d.invalid_hostname_characters)) {
            if (!l) throw new TypeError('Hostname "' + a + '" contains characters other than [A-Z0-9.-] and Punycode.js is not available');
            if (l.toASCII(a).match(d.invalid_hostname_characters)) throw new TypeError('Hostname "' + a + '" contains characters other than [A-Z0-9.-]');
        }
        ...
        l = !1, m = !1, p = !this._parts.urn; this._parts.hostname && (p = !1, c = d.ip4_expression.test(this._parts.hostname), e = d.ip6_expression.test(this._parts.hostname), b = c || e, h = (f = !b) && g && g.has(this._parts.hostname), l = f && d.idn_expression.test(this._parts.hostname), m = f && d.punycode_expression.test(this._parts.hostname)); switch (a.toLowerCase()) {
            ...
            case "idn": return l; case "url": return !this._parts.urn; case "urn": return !!this._parts.urn; case "punycode": return m
        } return null
    ...
    b) { var c; if (void 0 === a) return this.path() + this.search() + this.hash(); c = d.parse(a); this._parts.path = c.path; this._parts.query = c.query; this._parts.fragment = c.fragment; this.build(!b); return this }; e.subdomain = function (a, b) {
        ...
        this._parts.hostname && (this.is("IDN") && l ? this._parts.hostname = l.toASCII(this._parts.hostname) : this.is("IPv6") && m && (this._parts.hostname = m.best(this._parts.hostname)), this._parts.hostname =
    ...
    function (a) { "string" === typeof this._parts.query && (this._parts.query.length ? this.query(d.parseQuery(this._parts.query, this._parts.escapeQuerySpace)) : this._parts.query = null, this.build(!a)); return this }; e.normalizeFragment = function (a) { this._parts.fragment || (this._parts.fragment = null, this.build(!a)); return this }; e.normalizeSearch = e.normalizeQuery; e.normalizeHash = e.normalizeFragment; e.iso8859 = function () {
        ...
        var a = this.clone(); a.username("").password("").normalize(); var b = ""; a._parts.protocol && (b += a._parts.protocol + "://"); a._parts.hostname && (a.is("punycode") && l ? (b += l.toUnicode(a._parts.hostname), a._parts.port && (b += ":" + a._parts.port)) : b += a.host()); a._parts.hostname && a._parts.path && "/" !== a._parts.path.charAt(0) && (b += "/");
