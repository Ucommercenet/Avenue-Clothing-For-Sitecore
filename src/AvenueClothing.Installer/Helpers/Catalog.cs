...
namespace AvenueClothing.Installer.Helpers
{
    public class Catalog
    {
        ...
        private void CreateCasualShirts(Category shirts, ProductDefinition shirtDefinition)
        {
            ...
            AddProductProperty(prettyGreen, "ShowOnHomepage", "false");
        }
        ...
        private void CreateFormalShirts(Category shirts, ProductDefinition shirtDefinition)
        {
            ...
            AddProductProperty(kittens, "ShowOnHomepage", "false");
            ...
            AddProductProperty(pink, "ShowOnHomepage", "false");
            ...
            AddProductProperty(jungle, "ShowOnHomepage", "false");
            ...
            AddProductProperty(ghoulies, "ShowOnHomepage", "false");
            ...
            AddProductProperty(comic, "ShowOnHomepage", "false");
            ...
            AddProductProperty(rlA02, "ShowOnHomepage", "false");
            ...
            AddProductProperty(rlA04, "ShowOnHomepage", "false");
        }
        ...
        private void CreateShoes(ProductCatalog catalog)
        {
            ...
            AddProductProperty(marron, "ShowOnHomepage", "false");
            ...
            AddProductProperty(brown, "ShowOnHomepage", "false");
        }
        ...
        private void CreateScarves(Category accessories, ProductDefinition accessoryDefinition)
        {
            ...
            var lbas = CreateProductOnCategory(scarves, accessoryDefinition, "LBAS", "Luxury Baby Alpaca Scarf", 99, "75F07755-4499-4D35-A95C-FDAA1C448E4E", "<ul><li>100% Baby Alpaca Wool</li><li>180cm x 130cm (plus tassel fringe)</li><li>Fair Trade</li><li>Hypo-allergenic</li></ul><p>As featured on <a href=\"http://www.amazon.co.uk/Luxury-Threads-100%25-Alpaca-Throw/dp/B008WMLGCO/ref=sr_1_5?s=kitchen&ie=UTF8&qid=1349966612&sr=1-5\">Luxury Threads</a></p>");
            AddProductProperty(lbas, "ShowOnHomepage", "false");

            var p20178 = CreateProductOnCategory(scarves, accessoryDefinition, "20178", "Hugo Boss Black Frando Multi Colour Square Check Pattern Wool Scarf", 55, "D8951690-0B7B-4EFA-991F-7F710663068A", "<ul><li>Embroidered Hugo Boss Logo</li><li>Tassled Ends</li><li>Size 180 cm x 29 cm (including tassels)</li><li>Multi Colour Square Check Pattern</li><li>100% Virgin Wool</li><li>Style Number : 50230552 10159101 01 641</li></ul><p>As featured on <a href=\"http://www.pritchards.co.uk/accessories-14/scarves-32/hugo-boss-black-frando-multi-colour-20178.htm\">Pritchards.co.uk</a></p>");
            AddProductProperty(p20178, "ShowOnHomepage", "false");

            var p20180 = CreateProductOnCategory(scarves, accessoryDefinition, "20180", "Hugo Boss Black Farion Multi Colour Stripe ", 55, "FE3D4DB8-80A9-4CB7-B14D-10BE7F6C6C86", "<ul><li>Embroidered Hugo Boss logo</li><li>Tasselled ends</li><li>Size 180 cm x 25 cm (including tassels)</li><li>Multi Colour Stripe</li><li>100% Knitted Wool</li><li>Style Number : 50226493 10157685 01 960</li></ul><p>As featured on <a href=\"http://www.pritchards.co.uk/accessories-14/scarves-32/hugo-boss-black-farion-multi-colour-20180.htm\">Pritchards.co.uk</a></p>");
            AddProductProperty(p20180, "ShowOnHomepage", "false");
        }
        ...
        private void CreateTies(Category accessories, ProductDefinition accessoryDefinition)
        {
            ...
            paulSmith.Guid = new Guid("E43EFAD8-65B7-4F9A-87DD-B1EEEE469E22");
            AddProductProperty(paulSmith, "ShowOnHomepage", "false");

            var p19324 = CreateProductOnCategory(ties, accessoryDefinition, "19324", "Hugo Boss Black Dark Red Ultra Slim Knitted Tie", 65, "AE82EC87-391A-4B78-907F-3992BB79A55D", "", "<ul><li>Ultra slim knitted tie</li><li>Length: 145 cm </li><li> Width: 5 cm</li><li>Squared end</li><li>100% High-quality wool</li><li>Style Number : 5023476 10156986 01 504</li></ul><p>As featured on <a href=\"http://www.pritchards.co.uk/accessories-14/ties-25/hugo-boss-black-burgundy-ultra-slim-19324.htm\">Pritchards.co.uk</a></p>");
            AddProductProperty(p19324, "ShowOnHomepage", "false");

            var p20301 = CreateProductOnCategory(ties, accessoryDefinition, "20301", "Hugo Boss Black Pink & White Flower Pattern Silk Woven Tie", 65, "2A6BC0FF-24E6-4D2E-B87D-08899295ADAE", "Silky soft tie from Hugo Boss", "<ul><li>Flower Pattern Silk Tie</li><li>Tie Length : 145cm</li><li>Blade Width : 7.5cm</li><li>Black With Pink &amp; White Flowers</li><li>100% Silk (Made in Italy)</li><li>Style Number : 50227733 10156957 01 001</li></ul><p>As featured on <a href=\"http://www.pritchards.co.uk/accessories-14/ties-25/hugo-boss-black-pink-white-flower-20301.htm\">Pritchards.co.uk</a></p>");
            AddProductProperty(p20301, "ShowOnHomepage", "false");


            // Create product relation between the wonderland shirt and Paul Smith tie if it doesn't exist.
            if (ProductRelation.FirstOrDefault(x=>x.RelatedProduct == paulSmith && x.Product.Guid == new Guid("E43EFAD8-65B7-4F9A-87DD-B1EEEE469E21")) != null)
            {
                ProductRelation.Delete(x=>x.RelatedProduct == paulSmith && x.Product.Guid == new Guid("E43EFAD8-65B7-4F9A-87DD-B1EEEE469E21"));
            }
            CreateProductRelation(
                Product.FirstOrDefault(x => x.Guid == new Guid("E43EFAD8-65B7-4F9A-87DD-B1EEEE469E21")),
                ProductRelationType.FirstOrDefault(x => x.ProductRelationTypeId == 1),
                Product.FirstOrDefault(x=> x.Guid == new Guid("E43EFAD8-65B7-4F9A-87DD-B1EEEE469E22")));
        }

        private static void CreateProductRelation(Product product, ProductRelationType productRelationType,
