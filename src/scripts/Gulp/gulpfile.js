...
var fs = require('fs');
var unicorn = require("./tools/unicorn.js");
var habitat = require("./tools/habitat.js");
...
gulp.task("03-Publish-All-Projects", function (callback) {
  return runSequence(
    "Build-Solution",
    "Publish-AvenueClothing.B2C-Projects", callback);
});
...
gulp.task("Publish-AvenueClothing.B2C-Projects", function () {
	return publishProjects("./src/Publish-AvenueClothing.B2C-Projects");
});
